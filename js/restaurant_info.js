...
if ('serviceWorker' in navigator) {
  ...
  .then(function(registration) {
    ...
    console.log('CLIENT: service worker failed to register.', err);
  })
}
  ...
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) { // Got an error!
      ...
      L.tileLayer(
          ...
          {
            mapboxToken: 'pk.eyJ1IjoicHJlc2x5cCIsImEiOiJjampmNjlkZW00dXdpM2twMTRrMzQ5NXg3In0.x5CJtcEjm1iyRlOzvSYdjg',
            maxZoom: 18,
